...
class _BarcodeScannerScreenState extends State<BarcodeScannerScreen> {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          ...
          'Please grant camera permission in your device settings or use manual entry.',
        ),
        actions: [
          TextButton(
            onPressed: () {
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).pop(); // Close dialog
              _manualEntry(); // Open manual entry
            },
  ...
  Widget build(BuildContext context) {
    // Show manual entry only for web or if camera permission denied
