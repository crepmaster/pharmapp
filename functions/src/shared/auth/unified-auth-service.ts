...
export class UnifiedAuthService {
  ...
  static async createUserWithProfile(params: {
    userType: 'pharmacy' | 'courier' | 'admin';
    email: string;
    password: string;
   ...
   */
  private static validatePharmacyData(params: any): void {
   ...
   */
  private static validateCourierData(params: any): void {
   ...
   */
  private static validateAdminData(params: any): void {
   ...
   */
  private static getCollectionName(userType: 'pharmacy' | 'courier' | 'admin'): string {
    const collections = {
      pharmacy: 'pharmacies',
      courier: 'couriers',
      admin: 'admins',
   ...
   */
  private static async initializeUserWallet(
    userId: string,
    userType: 'pharmacy' | 'courier' | 'admin'
  ): Promise<void> {
    try {
   ...
   */
  static async cleanupOrphanUser(email: string): Promise<{
    success: boolean;
    message: string;
    actions: string[];
  }> {
