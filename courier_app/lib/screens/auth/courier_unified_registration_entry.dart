...
/// Entry point for courier registration using unified authentication
/// This replaces the old RegisterScreen with the new unified system
class CourierUnifiedRegistrationEntry extends StatelessWidget {
  const CourierUnifiedRegistrationEntry({super.key});
